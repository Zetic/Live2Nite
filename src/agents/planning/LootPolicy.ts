...
const BASE_LOOT_VALUE:Record<ItemType,number>={
  resource_pack:105,toolbox:104,metal_chest:96,xl_chest:120,food_box:88,decoration_box:64,safe:118,worn_leather_bag:170,
  ...
  mechanism:78,broken_electronic_device:82,belt:68,bag_of_damp_grass:46,bag_of_cement:72,earplugs:34,meaty_bone:62,human_flesh:60,poison_gland:82,working_radio:80,radio_cassette_player_off:68,guitar:66,table:70,trestle:86,chicken:62,stinking_pig:88,giant_rat:68,guard_dog:86,fat_cat:72,huge_snake:84,mangy_dachshund:82,furious_kitten_partially_digested:78,grisly_bomb:80,wire_mesh:72,grain_sack:58,full_jerrycan:76,
