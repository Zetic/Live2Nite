...
const BASE_LOOT_VALUE:Record<ItemType,number>={
  ...
  mechanism:78,broken_electronic_device:82,belt:68,bag_of_damp_grass:46,bag_of_cement:72,earplugs:34,meaty_bone:62,human_flesh:60,poison_gland:82,working_radio:80,radio_cassette_player_off:68,guitar:66,table:70,trestle:86,chicken:62,stinking_pig:88,giant_rat:68,guard_dog:86,fat_cat:72,huge_snake:84,wire_mesh:72,grain_sack:58,full_jerrycan:76,
