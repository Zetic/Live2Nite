...
export const ITEMS:Record<ItemType,ItemDefinition>={
  ...
  chicken:def({type:'chicken',name:'Chicken',purpose:'Ordinary source pet used by the Henhouse. It participates in the shared pet Watch, Animal Dump, and Small Trebuchet systems.',category:'misc',displayCategory:'miscellaneous',capabilities:['animal','component'],source:'MYHORDES_CURRENT'}),
  stinking_pig:def({type:'stinking_pig',name:'Stinking Pig',purpose:'Cumbersome ordinary source pet required by the source Pigsty construction. Butcher and Pigsty production behavior remain deferred until their current rules are audited.',category:'misc',displayCategory:'miscellaneous',capabilities:['animal','component'],source:'MYHORDES_CURRENT'}),
  giant_rat:def({type:'giant_rat',name:'Giant Rat',purpose:'Ordinary source pet found in several ruin loot tables. It participates in the shared pet Watch, Animal Dump, and Small Trebuchet systems.',category:'misc',displayCategory:'miscellaneous',capabilities:['animal'],source:'MYHORDES_CURRENT'}),
  guard_dog:def({type:'guard_dog',name:'Guard Dog',purpose:'Ordinary source pet with a high Watch value. It remains a normal inventory object across hauling, Watch, Dump, and Catapult interactions.',category:'misc',displayCategory:'defences',capabilities:['animal'],source:'MYHORDES_CURRENT'}),
  fat_cat:def({type:'fat_cat',name:'Fat Cat',purpose:'Ordinary source pet carrying 5 source decoration points and a Watch value. It remains a normal inventory object; decoration scoring is retained in source metadata.',category:'misc',displayCategory:'furniture',capabilities:['animal','decoration'],source:'MYHORDES_CURRENT'}),
  huge_snake:def({type:'huge_snake',name:'Huge Snake',purpose:'Cumbersome ordinary source pet found in ruin loot tables. It participates in the shared pet Watch, Animal Dump, and Small Trebuchet systems.',category:'misc',displayCategory:'miscellaneous',capabilities:['animal'],source:'MYHORDES_CURRENT'}),
