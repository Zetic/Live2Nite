...
export const ITEMS:Record<ItemType,ItemDefinition>={
  ...
  chicken:def({type:'chicken',name:'Chicken',purpose:'Ordinary source pet used by the Henhouse and accepted by the Butcher. It participates in pet Watch, Animal Dump, and Small Trebuchet systems.',category:'misc',displayCategory:'miscellaneous',capabilities:['animal','component'],source:'MYHORDES_CURRENT'}),
  stinking_pig:def({type:'stinking_pig',name:'Stinking Pig',purpose:'Cumbersome ordinary source pet required by the source Pigsty and accepted by the Butcher.',category:'misc',displayCategory:'miscellaneous',capabilities:['animal','component'],source:'MYHORDES_CURRENT'}),
  giant_rat:def({type:'giant_rat',name:'Giant Rat',purpose:'Ordinary source pet found in several ruin loot tables and accepted by the Butcher.',category:'misc',displayCategory:'miscellaneous',capabilities:['animal'],source:'MYHORDES_CURRENT'}),
  guard_dog:def({type:'guard_dog',name:'Guard Dog',purpose:'Ordinary source pet with a high Watch value and a source Butcher conversion.',category:'misc',displayCategory:'defences',capabilities:['animal'],source:'MYHORDES_CURRENT'}),
  fat_cat:def({type:'fat_cat',name:'Fat Cat',purpose:'Ordinary source pet carrying 5 source decoration points, a Watch value, and a source Butcher conversion.',category:'misc',displayCategory:'furniture',capabilities:['animal','decoration'],source:'MYHORDES_CURRENT'}),
  huge_snake:def({type:'huge_snake',name:'Huge Snake',purpose:'Cumbersome ordinary source pet found in ruin loot tables and accepted by the Butcher.',category:'misc',displayCategory:'miscellaneous',capabilities:['animal'],source:'MYHORDES_CURRENT'}),
  mangy_dachshund:def({type:'mangy_dachshund',name:'Mangy Dachshund',purpose:'Special Tamer Trap animal. It participates in animal systems, has an 18-point destructive Watch use, and can be butchered into two Tasty-looking Steaks.',category:'misc',displayCategory:'defences',capabilities:['animal'],source:'MYHORDES_CURRENT'}),
  furious_kitten_partially_digested:def({type:'furious_kitten_partially_digested',name:'Furious Kitten (partially digested)',purpose:'Special Tamer Trap animal with 1 decoration point and an 18-point destructive Watch use. Butchering it yields Grisly Bombs.',category:'misc',displayCategory:'furniture',capabilities:['animal','decoration'],source:'MYHORDES_CURRENT'}),
  grisly_bomb:def({type:'grisly_bomb',name:'Grisly Bomb',purpose:'Source flesh_#00 output from butchering a Furious Kitten. Its outside escape action remains intentionally partial until the source zone-escape behavior is integrated.',category:'misc',displayCategory:'armoury',capabilities:[],source:'MYHORDES_CURRENT'}),
  ...
  unspecified_meat:sourceFood('unspecified_meat','Unspecified Meat','Source undef_#00 Butcher output. Eating restores the ordinary daily food AP refresh.',false),
  fistful_of_insects:sourceFood('fistful_of_insects','Fistful of insects','Source moldy_food_subpart_#00 Tamer Trap failure output. Eating follows its ordinary 4-AP food action.',false),
  ...
  bump_key:def({type:'bump_key',name:'Bump Key',purpose:'Explorable-ruin door key. A matching locked room consumes it when opened.',category:'misc',displayCategory:'miscellaneous',capabilities:[],source:'MYHORDES_CURRENT'}),
