...
export const SPECIAL_SITES:Record<SpecialSiteType,SpecialSiteDefinition>={
  construction_site:{type:'construction_site',name:'Abandoned Construction Site',code:'C',purpose:'A concentrated source of construction-ready material and structural supplies.',lootPool:['twisted_plank','twisted_plank','wrought_iron','patchwork_beam','metal_support','sheet_metal','nuts_and_bolts','wire_reel','duct_tape','tool_bag','construction_kit','unshaped_concrete_block','old_door']},
  ...
  pharmacy:{type:'pharmacy',name:'Destroyed Pharmacy',code:'Rx',purpose:'Medical, chemical and improvised repair supplies.',lootPool:['pharmaceutical_products','pharmaceutical_products','poison_gland','duct_tape','kwik_fix','repair_kit','water_ration','box_of_matches']},
  supermarket:{type:'supermarket',name:'Abandoned Supermarket',code:'S',purpose:'Food, agricultural and household supplies.',lootPool:['food','food','food','water_ration','grain_sack','table','bag_of_damp_grass','plastic_bag','water_cooler_bottle','box_of_matches']},
