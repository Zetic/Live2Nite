...
export function canRunWorkshopRecipe(state:GameState,recipeId:WorkshopRecipeId):boolean{return state.town.construction.workshop.completed&&bankCount(state,WORKSHOP_RECIPES[recipeId].input)>=WORKSHOP_RECIPES[recipeId].inputCount}
