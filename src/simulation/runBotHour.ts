...
function meaningfulTownWork(event: GameEvent): boolean {
  return ['CONSTRUCTION_AP_CONTRIBUTED','WORKSHOP_CONVERTED','ITEMS_COMBINED','HOME_UPGRADED','HOME_IMPROVEMENT_BUILT','HOME_KITCHEN_USED','HOME_LAB_USED','ITEM_WITHDRAWN'].includes(event.type)
}
