...
export function chronicleCategory(event:GameEvent):ChronicleCategory{
  switch(event.type){
    ...
    case 'FLEE_ZOMBIES_RESOLVED':case 'WOUNDED_MOVEMENT_RESOLVED':case 'ZONE_CONTROL_LOST':case 'TEMPORARY_CONTROL_GRANTED':case 'TEMPORARY_CONTROL_EXPIRED':case 'ZONE_CONTROL_RESTORED':case 'CITIZEN_STATUS_CHANGED':case 'CITIZEN_DIED':return'survival'
