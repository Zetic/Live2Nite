...
export function chronicleCategory(event:GameEvent):ChronicleCategory{
  switch(event.type){
    ...
    case 'OPENABLE_RESOLVED':case 'CONTAINER_OPENED':case 'WATER_TAKEN':case 'ITEM_CONSUMED':case 'ITEM_ACTION_RESOLVED':case 'ITEMS_COMBINED':case 'SURVIVALIST_FORAGE_RESOLVED':return'supplies'
