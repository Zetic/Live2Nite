...
export function chronicleCategory(event:GameEvent):ChronicleCategory{
  switch(event.type){
    ...
    case 'OPENABLE_RESOLVED':case 'CONTAINER_OPENED':case 'WATER_TAKEN':case 'WATER_RETURNED':case 'WATER_PURIFIED':case 'WATER_ITEM_REFILLED':case 'ITEM_CONSUMED':case 'ITEM_ACTION_RESOLVED':case 'ITEMS_COMBINED':case 'SURVIVALIST_FORAGE_RESOLVED':return'supplies'
    ...
    case 'WORLD_ZOMBIES_EVOLVED':case 'WELL_WATER_CONSUMED':case 'NIGHT_RESOLVED':case 'DAY_STARTED':return'night'
    case 'SCOUT_MAPPING_COMPLETED':case 'GATE_SET':case 'COORDINATION_COMMITMENT_POSTED':case 'COORDINATION_COMMITMENT_CLEARED':return'town'
    case 'ITEM_MOVED_TO_HOME':case 'ITEM_MOVED_TO_RUCKSACK':case 'HOME_ITEM_DEPOSITED':case 'HOME_INTRUSION_ATTEMPTED':case 'HOME_ITEM_STOLEN':case 'HOME_ITEM_PILLAGED':case 'HOME_UPGRADED':case 'HOME_IMPROVEMENT_BUILT':case 'HOME_SIESTA_USED':case 'HOME_KITCHEN_USED':case 'HOME_LAB_USED':case 'CORPSE_DISPOSED':return'home'
