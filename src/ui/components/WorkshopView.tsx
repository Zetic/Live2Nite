...
import { WORKSHOP_RECIPE_ORDER, WORKSHOP_RECIPES, type WorkshopCategory, workshopRecipeApCost, workshopRecipeStock } from '../../core/workshop'
...
export function WorkshopView({game,legalActions,act}:{game:GameState;legalActions:GameCommand[];act:(command:GameCommand|undefined)=>void}){
  ...
  return <section className="panel screen-panel workshop-screen">
    <div className="panel-heading"><div><p className="section-kicker">Built facility</p><h2>Workshop</h2><p className="section-note">Transform materials, dismantle salvage, and restore Workshop-specific equipment. Portable assembling, reloading and ordinary repairs now belong to personal item actions.</p></div><span className="facility-status online">ONLINE</span></div>
