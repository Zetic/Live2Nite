...
export function eventTone(event:GameEvent):'town'|'world'|'night'|'danger'|'system'|'home'{
  switch(event.type){
    ...
    case 'ITEM_MOVED_TO_HOME':case 'ITEM_MOVED_TO_RUCKSACK':case 'OPENABLE_RESOLVED':case 'CONTAINER_OPENED':case 'CONSTRUCTION_KIT_OPENED':case 'ITEM_CONSUMED':case 'ITEMS_COMBINED':case 'HOME_UPGRADED':case 'HOME_IMPROVEMENT_BUILT':return'home'
