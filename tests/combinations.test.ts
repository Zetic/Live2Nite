...
describe('portable combinations',()=>{
  ...
  it('lets town AI prepare construction combinations by withdrawing Bank ingredients',()=>{
    ...
    game={...game,town:{...game.town,bank:bankFromCounts({bag_of_cement:1,water_ration:1},'concrete-prep'),construction:{...game.town.construction,foundations:{...game.town.construction.foundations,discovered:true,apContributed:1}}}}
