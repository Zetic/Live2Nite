...
import { CONSTRUCTIONS, constructionUnlocked, temporaryCompletedProjects } from '../src/core/construction'
...
describe('construction discovery progression', () => {
  ...
  it('keeps temporary plans known after their one-night construction expires', () => {
    ...
    game={...game,town:{...game.town,construction:{
      ...game.town.construction,
      bait:{...game.town.construction.bait,discovered:true,completed:true,apContributed:CONSTRUCTIONS.bait.apCost},
    }}}
