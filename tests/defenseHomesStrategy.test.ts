...
function completed(game:GameState,projectId:keyof GameState['town']['construction']):GameState{
  return{...game,town:{...game.town,construction:{...game.town.construction,[projectId]:{...game.town.construction[projectId],completed:true,apContributed:CONSTRUCTIONS[projectId].apCost}}}}
}
