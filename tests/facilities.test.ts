...
function outsideAt(game: GameState, x: number, y: number): GameState {
  return {
    ...game,
    citizens: game.citizens.map((citizen) => citizen.id === 'c01' ? { ...citizen, location: { type: 'world' as const, x, y } } : citizen),
  }
}
...
describe('undepleted and depleted scavenging', () => {
  it('starts schema v5 and keeps low-grade Workshop feedstock out of the normal loot pool', () => {
  ...
  it('uses normal loot while a zone is undepleted', () => {
    ...
    game = {
      ...
      world: {
        ...
        zones: {
          ...game.world.zones,
          [key]: { ...game.world.zones[key], zombies: 0, searchesRemaining: 1, hiddenLoot: ['twisted_plank'], searchedBy: [], depletedSearchedBy: [] },
        },
      },
    }
  ...
  it('lets a citizen comb a depleted zone once for Workshop feedstock', () => {
    ...
    game = {
      ...
      world: {
        ...
        zones: {
          ...game.world.zones,
          [key]: { ...game.world.zones[key], zombies: 0, searchesRemaining: 0, hiddenLoot: [], searchedBy: ['c01'], depletedSearchedBy: [] },
        },
      },
    }
    ...
    game = {
      ...
      town: {
        ...
        construction: {
          ...
          workshop: { id: 'workshop', completed: true, apContributed: 25 },
        },
      },
    }
