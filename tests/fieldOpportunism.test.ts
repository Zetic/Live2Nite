...
describe('field opportunism and hydration assurance',()=>{
  ...
  it('drops a low-value carry before taking a substantially better ground item',()=>{
    ...
    game=patchCitizen(game,'c02',{location:{type:'world',x:2,y:0},inventory:[item('a','battery'),item('b','box_of_matches'),item('c','pharmaceutical_products'),item('d','broken_human_bone'),item('e','rotting_log')],ap:4})
